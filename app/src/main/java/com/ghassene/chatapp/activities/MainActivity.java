...
import com.ghassene.chatapp.adapters.RecentConversationAdapter;
import com.ghassene.chatapp.databinding.ActivityMainBinding;
import com.ghassene.chatapp.listeners.ConversionListener;
                ...
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    for (int i = 0; i < conversations.size(); i++) {
                        if (conversations.get(i).senderId.equals(documentChange.getDocument().getString(Constants.KEY_SENDER_ID)) &&
                                conversations.get(i).receiverId.equals(documentChange.getDocument().getString(Constants.KEY_RECEIVER_ID))) {
